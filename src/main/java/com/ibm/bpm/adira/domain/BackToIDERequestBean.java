...
public class BackToIDERequestBean {
	...
	public BackToIDERequestBean(String orderID, int processID, int taskID, Boolean mayor, int brmsScoring)
	{
		this.orderID = orderID;
		this.processID = processID;
		this.taskID = taskID;
